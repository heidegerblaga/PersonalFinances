...
def scan(img):
    ...
    cv2.imwrite('processed_image.jpg', final)
...
if __name__=='__main__':
    ...
    img = Image.open('folder/IMG_20230919_161219.jpg')
    image = cv2.imread('folder/IMG_20230919_161219.jpg')
